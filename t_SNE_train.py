...
model1.fit(B_red, G_red, epochs=1000, batch_size=535,  verbose=1, callbacks=[tbCallBack])
...
model2.fit(B_red, G_red, epochs=1000, batch_size=535,  verbose=1, callbacks=[tbCallBack])
