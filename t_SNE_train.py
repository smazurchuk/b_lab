...
model1.add(Dense(10, kernel_initializer='normal', activation='sigmoid'))
model1.add(Dense(5, kernel_initializer='normal'))
model1.compile(loss='mean_absolute_percentage_error', optimizer='Adagrad')
model1.fit(B_red, G_red, epochs=40000, batch_size=535,  verbose=1)
...
model2.compile(loss='mean_absolute_percentage_error', optimizer='Adagrad')
model2.fit(B_red, G_red, epochs=40000, batch_size=535,  verbose=1)
...
model3.compile(loss='mean_absolute_percentage_error', optimizer='Adagrad')
model3.fit(B_red, G_red, epochs=40000, batch_size=534,  verbose=1)
